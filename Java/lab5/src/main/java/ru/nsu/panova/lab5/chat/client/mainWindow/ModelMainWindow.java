package ru.nsu.panova.lab5.chat.client.mainWindow;
...
import ru.nsu.panova.lab5.chat.client.entranceWindow.LoaderEntranceWindow;
import ru.nsu.panova.lab5.chat.client.mainWindow.communicatingWithServer.ReadMsg;
import ru.nsu.panova.lab5.chat.client.mainWindow.communicatingWithServer.WriteMsg;
import ru.nsu.panova.lab5.chat.client.observer.ObservableChat;
import ru.nsu.panova.lab5.chat.client.mainWindow.communicatingWithServer.Command.*;
...
public class ModelMainWindow extends ObservableChat {
    ...
    private FactoryClientCommand fabricCommand = new FactoryClientCommand();
