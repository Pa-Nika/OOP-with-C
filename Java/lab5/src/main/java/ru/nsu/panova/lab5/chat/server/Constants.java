package ru.nsu.panova.lab5.chat.server;

public class Constants {
    public static final int SOCKET = 11111;
    public static final String FABRIC_CONFIGURATION_FILE_NAME = "src/main/java/ru/nsu/panova/lab5/chat/server/fileConfiguration";
